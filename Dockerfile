...
WORKDIR "/opt"
RUN curl -sLO https://github.com/oracle/graal/releases/download/vm-19.1.0/graalvm-ce-linux-amd64-19.1.0.tar.gz
RUN tar -xzf graalvm-ce-linux-amd64-19.1.0.tar.gz
ENV GRAALVM_HOME="/opt/graalvm-ce-19.1.0"
ENV JAVA_HOME="/opt/graalvm-ce-19.1.0/bin"
