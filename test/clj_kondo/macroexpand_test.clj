...
(deftest macroexpand-test
  (assert-submaps
   '({:file "corpus/macroexpand.clj", :row 15, :col 7, :level :error, :message "Expected: number, received: keyword."}
     ...
     {:file "corpus/macroexpand.clj", :row 28, :col 48, :level :warning, :message "unused binding tree"}
     {:file "corpus/macroexpand.clj", :row 36, :col 1, :level :warning, :message "Missing catch or finally in try"})
