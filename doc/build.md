...
* Download [GraalVM](https://www.graalvm.org/downloads) Oracle GraalVM 25.0.4.

* Set the `GRAALVM_HOME` variable. E.g.:

        export GRAALVM_HOME=~/Downloads/graalvm-jdk-25.0.4/Contents/Home
...
*  set the `GRAALVM_HOME` environment variable:
         ...
         set GRAALVM_HOME=C:\Users\IEUSer\Downloads\graalvm-jdk-25.0.4
