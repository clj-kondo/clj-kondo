...
- [#2624](https://github.com/clj-kondo/clj-kondo/issues/2624): lint argument types passed to `get` (especially to catch swapped arguments to get in threading macros)
