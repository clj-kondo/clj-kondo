...
## Unreleased
 ...
 - Add linter `:repeated-arity`: warn when an arity repeats in a function that overloads on arity. [#1136](https://github.com/clj-kondo/clj-kondo/issues/1136) ([@mknoszlig](https://github.com/mknoszlig))
