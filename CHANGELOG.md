...
- [#2732](https://github.com/clj-kondo/clj-kondo/issues/2732): `unreachable-code`: warn when `:default` does not come last in reader conditionals as part of ([@jramosg](https://github.com/jramosg))
