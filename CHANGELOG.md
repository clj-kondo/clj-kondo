...
- [#1891](https://github.com/clj-kondo/clj-kondo/issues/1891): add `:extra-config-paths` config option and `CLJ_KONDO_EXTRA_CONFIG_PATHS` env variable to override project config
