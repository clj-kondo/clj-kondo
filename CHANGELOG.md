...
- [#2459](https://github.com/clj-kondo/clj-kondo/issues/2459): NEW linter: `:eager-or-expression` to warn on s-expressions in `:or` defaults in map destructuring ([@jramosg](https://github.com/jramosg))
