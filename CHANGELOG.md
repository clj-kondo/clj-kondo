...
- [#2653](https://github.com/clj-kondo/clj-kondo/issues/2653): NEW linter: `:unquote-outside-syntax-quote` to warn on `~` and `~@` usage outside syntax-quote (`` ` ``)
- [#2653](https://github.com/clj-kondo/clj-kondo/issues/2653): NEW linter: `:unquote-outside-syntax-quote` to warn on `~` and `~@` usage outside syntax-quote (`` ` ``) ([@jramosg](https://github.com/jramosg))
## 2025.10.23
