...
## Unreleased
- [#1653](https://github.com/clj-kondo/clj-kondo/issues/1653): new linter `:keyword-in-binding-vector` warns when a keyword is used in a `:keys` binding vector. This linter is `:off` by default. See [docs](doc/linters.md#keyword-in-binding-vector).
