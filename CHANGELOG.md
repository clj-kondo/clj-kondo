...
- [#2732](https://github.com/clj-kondo/clj-kondo/issues/2732): NEW linter: `:reader-conditional-default-not-last` to warn when `:default` does not come last in reader conditionals ([@jramosg](https://github.com/jramosg))
