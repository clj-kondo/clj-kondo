...
- [#2624](https://github.com/clj-kondo/clj-kondo/issues/2624): NEW linter: `:get-on-key`: warn about swapped order of the first two arguments to `get` in some cases (keyword, number)
