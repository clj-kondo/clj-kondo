...
- [#2062](https://github.com/clj-kondo/clj-kondo/issues/2062): NEW linter: `:redundant-if` which suggests `(or x y)` instead of `(if x x y)` when the condition is a simple symbol (default level: `:off`) ([@jramosg](https://github.com/jramosg))
