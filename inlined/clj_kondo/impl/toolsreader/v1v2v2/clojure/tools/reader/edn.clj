...
(ns ^{:no-doc true} clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.edn
  ...
  (:require [clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.reader-types :refer
            ...
            [clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader :refer [default-data-readers]])
...
(defn read
  "Reads the first object from an IPushbackReader or a java.io.PushbackReader.
   ...
   clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.edn/read doesn't depend on dynamic Vars, all configuration
...
(defn read-string
  "Reads one object from the string s.
   ...
   opts is a map as per clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.edn/read"
