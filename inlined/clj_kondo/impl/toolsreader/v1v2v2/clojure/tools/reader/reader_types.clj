...
(ns ^{:no-doc true} clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.reader-types
  (:refer-clojure :exclude [char read-line])
  (:require [clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.impl.utils :refer [char whitespace? newline? make-var]])
...
(extend-protocol ReaderCoercer
  ...
  clj_kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.reader_types.Reader
  (to-rdr [rdr] rdr)
  String
...
(extend-protocol PushbackReaderCoercer
  ...
  clj_kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.reader_types.PushbackReader
  (to-pbr [rdr buf-len] (push-back-reader rdr buf-len))
  String
...
(defn indexing-reader?
  ...
  [rdr]
  (or (instance? clj_kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.reader_types.IndexingReader rdr)
      (instance? LineNumberingPushbackReader rdr)
      (and (not (instance? clj_kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.reader_types.PushbackReader rdr))
           (not (instance? clj_kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.reader_types.StringReader rdr))
           (not (instance? clj_kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.reader_types.InputStreamReader rdr))
