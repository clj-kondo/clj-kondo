...
(ns ^{:no-doc true} clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader
  ...
  (:require [clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.reader-types :refer
            ...
            [clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.impl.utils :refer :all] ;; [char ex-info? whitespace? numeric? desugar-meta]
            [clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.impl.errors :as err]
            [clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.impl.commons :refer :all]
            [clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.default-data-readers :as data-readers])
...
(def ^:dynamic *read-eval*
   ...
   ***WARNING***
   ...
   used with untrusted sources. See also: clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.edn/read.
...
(def ^:dynamic *data-readers*
  "Map from reader tag symbols to data reader Vars.
   ...
   Default reader tags are defined in clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader/default-data-readers
...
(defn read
   ...
   ***WARNING***
   ...
   To read data structures only, use clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.edn/read

   Note that the function signature of clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader/read and
   clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.edn/read is not the same for eof-handling"
...
(defn read-string
   ...
   ***WARNING***
   ...
   To read data structures only, use clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.edn/read-string

   Note that the function signature of clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader/read-string and
   clj-kondo.impl.toolsreader.v1v2v2.clojure.tools.reader.edn/read-string is not the same for eof-handling"
  ([s]
     (read-string {} s))
  ([opts s]
