...
(ns ^{:no-doc true} clj-kondo.impl.toolsreader.v1v2v2.cljs.tools.reader.reader-types
  (:refer-clojure :exclude [char read-line])
  (:require [clj-kondo.impl.toolsreader.v1v2v2.cljs.tools.reader.impl.utils :refer [char whitespace? newline?]]
            [goog.string])
