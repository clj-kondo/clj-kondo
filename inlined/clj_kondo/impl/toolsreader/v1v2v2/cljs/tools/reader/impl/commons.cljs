...
(ns ^{:no-doc true} clj-kondo.impl.toolsreader.v1v2v2.cljs.tools.reader.impl.commons
  (:refer-clojure :exclude [char])
  (:require
   [clj-kondo.impl.toolsreader.v1v2v2.cljs.tools.reader.impl.errors :refer [reader-error]]
   [clj-kondo.impl.toolsreader.v1v2v2.cljs.tools.reader.reader-types :refer [peek-char read-char]]
   [clj-kondo.impl.toolsreader.v1v2v2.cljs.tools.reader.impl.utils :refer [numeric? newline? char]]))
